...
function () {
  ...
  _createClass(Theme, [{
    ...
    value: function parse() {
      ...
      var path = _get__("getThemePath")(_get__("config"));
...
function getThemePath(config) {
  ...
  var files = _get__("glob").sync(process.cwd() + '/' + config.theme + '**/*');
...
var _typeOfOriginalExport = _typeof(Theme);
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && Object.isExtensible(Theme)) {
