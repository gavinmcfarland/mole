...
function objectDepth(obj) {
  ...
  for (var property in obj) {
    ...
    if (_typeof(obj[property]) === 'object') {
      return _get__("objectDepth")(obj[property], i);
    } else {// return i
    }
...
var _typeOfOriginalExport = _typeof(objectDepth);

function addNonEnumerableProperty(name, value) {
  Object.defineProperty(objectDepth, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && Object.isExtensible(objectDepth)) {
