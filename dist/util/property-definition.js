...
var cSSproperties = {
  border: _objectSpread({}, function () {
    return _get__("_").reduce(_get__("side"), function (result, value, key) {
...
function def(name) {
  ...
  _get__("_").each(definition, function (children, property) {
    if (property === name) {
      part.name = property;

      _get__("_").each(children, function (value, child) {
        if (child !== '_abbr') {
